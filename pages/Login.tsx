...
const Login: React.FC = () => {
  ...
  const { login, fontFamily, pharmacyName } = usePharmacy();
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className={`w-full px-4 py-2.5 bg-white border border-slate-300 rounded-lg focus:ring-2 focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)] outline-none font-medium ${role ? 'text-slate-700' : 'text-slate-400'}`}
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              <button 
                ...
                className="text-xs font-bold text-[var(--color-text)] hover:underline disabled:opacity-50 disabled:cursor-not-allowed"
                disabled={isLocked}
              >
                Forgot Password?
              </button>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-3 text-slate-400 hover:text-slate-600 focus:outline-none p-0.5 rounded-md hover:bg-slate-100 transition-colors disabled:opacity-50"
                disabled={isLocked}
              >
            ...
            <div className="p-6">
              {forgotStep === 'email' && (
                <form onSubmit={handleSendCode} className="space-y-4">
                  ...
                  {resetError && (
                    <div className="bg-red-50 text-red-600 px-4 py-3 rounded-lg text-sm border border-red-200 font-medium flex items-start gap-2">
              ...
              {forgotStep === 'success' && (
                <div className="text-center py-4">
                  ...
                  <h4 className="font-bold text-xl text-slate-800">Password Reset Successfully!</h4>
                  <p className="text-slate-500 text-sm mt-2 mb-6">A temporary password has been sent to your email address. Please check your inbox (and spam folder) and log in with the temporary password. You can change it after logging in.</p>
