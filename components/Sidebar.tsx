...
const Sidebar: React.FC<SidebarProps> = ({ isOpen = false, onClose }) => {
  const { logout, pharmacyName, user, isSidebarCollapsed, setSidebarCollapsed } = usePharmacy();
         ...
         {/* Header / Logo Section */}
          <div className="pt-8 pb-6 px-6 flex flex-col items-center text-center">
            ...
            <button 
              ...
              className="absolute top-4 right-4 hidden md:block text-slate-800 hover:bg-black/10 p-1 rounded-full"
            >
              <X size={24} />
            </button>
          </div>
              ...
              <>
                ...
                <div>
                  <button
                    ...
                    className="w-full flex items-center gap-4 px-6 py-3.5 mx-4 rounded-xl transition-all duration-200 font-bold text-slate-800 hover:bg-white/40"
                  >
